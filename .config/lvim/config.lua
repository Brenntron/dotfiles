...
lvim.plugins = {
	{
		...
		event = "BufRead",
		config = function()
			require("trim").init({ trim_last_line = false })
		end,
	},
	{
	...
	{ "kristijanhusak/vim-dadbod-ui", dependencis = "tpope/vim-dadbod" },
	{ "junegunn/vim-easy-align" },
	{
		"norcalli/nvim-colorizer.lua",
		config = function()
			require("colorizer").init({ "css", "html", "javascript", "scss" }, {
			...
			function()
				require("neotest").init({
					adapters = {
						...
						require("neotest-vim-test")({ ignore_file_types = { "vim" } }),
					},
				})
			end,
		},
...
lvim.builtin.treesitter.ignore_install = { "C", "haskell" }
...
formatters.setup({
	{ name = "beautysh", filetypes = { "bash", "zsh" } },
	{ name = "erb_lint", filetypes = { "erb" } },
...
lvim.lsp.installer.setup.ensure_installed = { "cssls", "haml-lint", "jsonls", "rubocop", "sumneko_lua" }
