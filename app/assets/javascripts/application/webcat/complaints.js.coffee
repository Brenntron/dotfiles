...
#          else
#            history_dialog_content +=
#              '<table class="history-table"><thead><tr><th>Action</th><th>Confidence</th><th>Description</th><th>Time</th><th>User</th><th>Category</th></tr></thead><tbody>'
...
#            history_dialog_content += '</div><div class="tab-pane" role="tabpanel" id="complaint-history-tab"><h5>Complaint Entry History</h5>'
#
...
#            else
#              history_dialog_content += '<table class="history-table"><thead><th>Time</th><th>User</th><th>Details</th></thead><tbody>'
#
