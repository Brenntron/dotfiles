        ...
        get '/tabs/:id' do
          begin
            ...
            tasks.each do |task|
              ...
              response_task['created_at'] = task.created_at.in_time_zone("Eastern Time (US & Canada)").strftime("%m/%d/%y %H:%M:%S") #change in_time_zone to reflect the users timezone.(when we have configurations for this stuff)
