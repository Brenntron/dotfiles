  ...
  def process_resolution_changes(resolution, internal_comment, customer_facing_comment)
    ...
    if !["COMPLETED","PENDING"].include?(self.status) && resolution != "REOPENED"
      if self.is_important
        ...
        confirmation.update(status: 'SUCCESS', host: self.hostlookup, status: self.status, resolution: resolution, internal_comment: internal_comment, customer_facing_comment: customer_facing_comment,
      ...
      confirmation.update(status: 'ERROR', host: self.hostlookup, status: self.status,resolution: resolution, internal_comment: internal_comment, customer_facing_comment: customer_facing_comment,
