...
class ComplaintEntry < ApplicationRecord
  ...
  def take_complaint(current_user, assignment_type)
    ...
    elsif assignment_type == 'reviewer' && reviewer.nil? && second_reviewer&.id == current_user&.id
    ...
    elsif assignment_type == 'second_reviewer' && second_reviewer.nil? && reviewer&.id == current_user&.id
