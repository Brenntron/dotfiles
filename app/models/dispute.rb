      ...
      case
        ...
        when dispute.user_id?
          if dispute.user_id == user.id
            ...
            dispute_packet[:assigned_to] = dispute.user.cvs_username + " <button class='take-ticket-button take-dispute-#{dispute.id}' title='Assign this ticket to me' onclick='take_dispute(#{dispute.id});'></button>"
          end
      end
