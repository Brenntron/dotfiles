class TiApi::AmpNamingPattern < TiApi::Base
  attr_reader :m_amp_naming_convention, :prev_position

  def initialize(m_amp_naming_convention)
    @m_amp_naming_convention = m_amp_naming_convention
    @prev_position = m_amp_naming_convention.table_sequence
  end
  ...
  def update!(amp_naming_convention_given = m_amp_naming_convention)
    ...
    input = {
        ...
        amp_naming_pattern: {
            ...
            position: amp_naming_convention_given.table_sequence,
    ...
    @prev_position = amp_naming_convention_given.table_sequence
    return true
  end
end
