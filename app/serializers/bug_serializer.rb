class BugSerializer < ActiveModel::Serializer
  attributes :id, :bugzilla_id, :state, :status, :resolution, :summary, :committer_id, :user_id, :gid, :sid, :rev, :notes, :product, :component, :description, :version, :research_notes, :committer_notes, :created_at, :updated_at, :assigned_at, :pending_at, :resolved_at, :reopened_at, :work_time, :review_time, :rework_time,:attachments
