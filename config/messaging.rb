...
ActiveMessaging::Gateway.define do |s|
  ...
  s.destination :snort_all_rules_test_work, '/queue/RulesUI.Snort.Run.All.Work'
  s.destination :snort_all_rules_test_result, '/queue/RulesUI.Snort.Run.All.Result'
  ...
  s.destination :snort_commit_test_work, '/queue/RulesUI.Snort.Commit.Work'
  s.destination :snort_commit_test_result, '/queue/RulesUI.Snort.Commit.Result'
  s.destination :snort_commit_test_reload, '/queue/RulesUI.Snort.Commit.Reload'
