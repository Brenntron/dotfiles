...
am = User.create(kerberos_login:"amcdonnell",cvs_username:"amcdonnell",cec_username:"almcdonn",display_name:"Alex McDonnell",committer:false,email:"almcdonn@cisco.com",confirmed:true,password:'acpassword',password_confirmation:'acpassword')
am.roles << Role.where(role: 'analyst')
am.move_to_child_of(pm)

nr = User.create(kerberos_login:"drandolph",cvs_username:"drandolph",cec_username:"nrandolp",display_name:"Nick Randolph",committer:false,email:"nrandolp@cisco.com",confirmed:true,password:'acpassword',password_confirmation:'acpassword')
