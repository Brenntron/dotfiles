CREATE TABLE `giblets` (`id` bigint NOT NULL AUTO_INCREMENT PRIMARY KEY, `bug_id` int, `gib_type` varchar(255), `gib_id` bigint,  INDEX `index_giblets_on_gib_type_and_gib_id`  (`gib_type`, `gib_id`)) ENGINE=InnoDB
