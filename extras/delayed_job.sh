...
do
        ...
        do
                ...
                then
                        HOME=/var/log/analyst-console RAILS_ENV=${RAILS_ENV} GEM_HOME=${RAILS_ROOT}/vendor/bundle/ruby/2.4/gems ${PREFIX}/bin/bundle exec ${RAILS_ROOT}/bin/$process -n ${NUMBER_OF_DELAYED_JOBS} $1
                fi
