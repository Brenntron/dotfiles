...
do
	...
	do
		...
		then
		    HOME=/var/log/analyst-console-escalations RAILS_ENV=${RAILS_ENV} GEM_HOME=${DJ_RAILS_ROOT}/vendor/bundle/ruby/2.4/gems ${PREFIX}/bin/bundle exec ${DJ_RAILS_ROOT}/bin/$process $1
        else
