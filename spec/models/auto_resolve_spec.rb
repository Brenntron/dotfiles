describe AutoResolve do
  describe 'checking sources' do
    ...
    it 'skips complaints' do
      allow(Rails.configuration.auto_resolve).to receive(:check_complaints).and_return(false)
      allow(Rails.configuration.auto_resolve).to receive(:check_virus_total).and_return(false)
      allow(Rails.configuration.auto_resolve).to receive(:check_umbrella).and_return(false)
    ...
    it 'produces new ticket when complaints hits and VT and Umbrella convict' do
      allow(Rails.configuration.auto_resolve).to receive(:check_complaints).and_return(true)
      allow(Rails.configuration.auto_resolve).to receive(:check_virus_total).and_return(true)
    ...
    it 'produces new ticket when complaints hits and VT and Umbrella aquit' do
      allow(Rails.configuration.auto_resolve).to receive(:check_complaints).and_return(true)
      allow(Rails.configuration.auto_resolve).to receive(:check_virus_total).and_return(true)
      allow(Rails.configuration.auto_resolve).to receive(:check_umbrella).and_return(true)
